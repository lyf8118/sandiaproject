...
|                                                                             |
+-----------------------------------------------------------------------------+
|  Source: UsbHid.h, v1.12 2009/05/26                                         |
|  Author: Rostyslav Stolyar                                                  |
|                                                                             |
|  WHO          WHEN         WHAT                                             |
|  ---          ----------   ------------------------------------------------ |
|  R.Stolyar    2009/02/20   portet from UsbCdc.h                             |
|  R.Stolyar    2009/05/15   added param to USBHID_rejectData()               |
...
#define kUSBHID_receiveError        0x07
