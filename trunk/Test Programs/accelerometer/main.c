...
static unsigned int results1[numSamples];
static unsigned int results2[numSamples];
static unsigned int results3[numSamples];
static unsigned int results4[numSamples];
static int count = 0;// Needs to be global in this example
...
{
  results1[count] = ADC12MEM0;                   // Move results, IFG is cleared
  results2[count] = ADC12MEM1;                   // Move results, IFG is cleared
  results3[count] = ADC12MEM2;                   // Move results, IFG is cleared
  results4[count] = ADC12MEM3;                   // Move results, IFG is cleared
  count++;
