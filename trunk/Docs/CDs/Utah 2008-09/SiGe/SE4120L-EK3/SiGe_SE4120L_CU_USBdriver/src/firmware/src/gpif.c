...
void GpifInit( void )			// **** MIS - I don't think that this function is called anyhow !
{
  BYTE i;
  ...
  IFCONFIG = 0xAE; 	// 10101110 	
  // IFCLKSRC=1   , FIFOs executes on internal clk source	 **** external required for EK3 ?
  // xMHz=1       , 48MHz internal clk rate                                  *** this should be 1 but above is set to zero - MIS
